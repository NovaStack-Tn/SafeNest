          ...
          {detections.length > 0 && (
            <motion.div
              ...
              className={`space-y-3 rounded-xl p-4 border ${
                detections.every(d => d.identity_label)
                        ...
                        {det.identity_label ? (
                          <div className="space-y-3">
                            <div className="flex items-start space-x-3">
                              {det.photo && (
                                <img 
                                  src={`http://localhost:8000${det.photo}`}
                                  alt={det.identity_label}
                              ...
                              <div className="flex-1">
                                  ...
                                  <div className="flex items-center space-x-2">
                                    <div className="flex-1 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                      <div 
                                        ...
                                        style={{ width: `${det.similarity * 100}%` }}
                                      ></div>
                                    </div>
                                ...
                                {det.person_meta && (
                                  <div className="mt-2 text-xs text-gray-600 dark:text-gray-400">
                                    {Object.entries(det.person_meta).map(([key, value]) => (
                                      <div key={key}>
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center space-x-3 p-4 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-300 dark:border-yellow-700 rounded-lg">
                            ...
                            <div className="text-xs text-gray-500 dark:text-gray-400 italic">
                              To identify this person, enroll their face in the system first.
                            </div>
                          </div>
                        )}
