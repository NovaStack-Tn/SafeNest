...
INSIGHTFACE_SIMILARITY_THRESHOLD = float(os.environ.get('INSIGHTFACE_SIMILARITY_THRESHOLD', '0.4'))

# Face Recognition Settings
FACE_RECOGNITION_TOP_K = 3
FACE_EMBEDDING_DIM = 512

# Anomaly Detection Settings
ANOMALY_ISOLATION_FOREST_CONTAMINATION = 0.1
ANOMALY_DETECTION_FEATURES = ['hour', 'day_of_week', 'country_code', 'device_entropy']
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'safenest.log',
